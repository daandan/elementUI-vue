  ...
  <div class="app-container calendar-list-container">
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="拼命加载中" :height="tableHeight" border stripe fit
      ...
      <el-table-column align="center" width="100px" label="市场价" prop="marketPrice" sortable>
        <template scope="scope">
          <span class="link-type" @click="handleUpdate(scope.row)">{{scope.row.price}}</span>
        </template>
      </el-table-column>
...
const testData = [
  {
    ...
    url: 'https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2067888003,581770014&fm=200&gp=0.jpg',
    status: 1,
    price:123
  },
  {
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      this.$router.push({path: '/good/add-good'})
    }
  },
